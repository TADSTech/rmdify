...
import NewDocMobile from '../components/doc/newdocmobile'
...
export default function MainMobileApp() {
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div className="flex-1" onClick={() => loadDocument(doc.id)}>
                  ...
                  <p className="text-sm mb-1 line-clamp-2" style={{ color: 'var(--text-muted)' }}>
                ...
                <div className="flex flex-col gap-1">
                  <button
                    ...
                    onTouchStart={(e) => e.currentTarget.style.backgroundColor = 'var(--bg-tertiary)'}
      ...
      <main className="flex-1 overflow-hidden" style={{ backgroundColor: 'var(--bg)', color: 'var(--text)' }}>
        {currentView === 'welcome' ? (
          <div className="p-6 h-full overflow-auto">
            <h1 className="text-3xl mb-3 font-bold">Welcome to Rmdify</h1>
            <p className="text-muted mb-6">Mobile version - Tap the menu to navigate.</p>
            <div className="mt-6">
              <h2 className="text-xl font-semibold mb-3">Quick Start</h2>
              <ul className="space-y-2 text-muted text-sm">
                <li>• Tap "New Document" to create a markdown file</li>
                <li>• Use "Open Document" to load an existing file</li>
                <li>• Access your recent and starred documents from the menu</li>
                <li>• Switch between Editor and Preview tabs while writing</li>
              </ul>
            </div>
          </div>
        ) : currentView === 'newdoc' ? (
          <NewDocMobile key={selectedDocId || 'new'} initialDocId={selectedDocId} />
        ) : currentView === 'recent' ? (
